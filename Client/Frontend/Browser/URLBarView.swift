...
class URLBarView: UIView {
    ...
    lazy var shareButton: UIButton = { return self.insettedToolbarButton() }()

    lazy var bookmarkButton: UIButton = { return self.insettedToolbarButton() }()

    lazy var forwardButton: UIButton = { return self.insettedToolbarButton() }()

    lazy var backButton: UIButton = { return self.insettedToolbarButton() }()

    lazy var stopReloadButton: UIButton = { return self.insettedToolbarButton() }()

    lazy var actionButtons: [UIButton] = {
        return [self.shareButton, self.bookmarkButton, self.forwardButton, self.backButton, self.stopReloadButton]
    }()

    private func insettedToolbarButton() -> UIButton {
        var button = UIButton()
        button.contentEdgeInsets = URLBarViewUX.ToolbarButtonInsets
        return button
    }
